...
4. **Clarifying Gate**：落笔前向用户确认北极星、主要用户/场景、关键取舍、能力边界和
   必须排除的表面方案。对尚未由项目事实充分回答的问题，执行 SEARCH_METHODOLOGY.md 的
   Research Gate：针对性搜索外部证据、提取机制、转译成项目后果。
5. 当用户提出的表面方案与真实目标冲突时，指出冲突并给出更直接的目标表达。
6. 不为了显得有远见扩大产品范围，也不把技术限制擅自改写成产品意志。
7. 当北极星、用户场景、竞品/替代方案或关键能力未知时，必须先搜索并记录证据，
   不得在缺少证据时臆断落笔。
